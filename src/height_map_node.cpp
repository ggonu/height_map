...
// #include "height_map/generate_height_map.hpp"
...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber point_cloud_sub = nh.subscribe("/plane_seg/hull_cloud", 1, pointCloudCallback);

    ros::Rate rate(1.0);
    while (ros::ok()) {
      // ros::Subscriber point_cloud_sub = nh.subscribe("/d435i_cloud", 1, pointCloudCallback);
      ros::spinOnce();
      rate.sleep();
    }
